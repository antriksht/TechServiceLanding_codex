...
const Hero: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      text: "AI/ML-Powered Forecasting",
    },
    {
      icon: <ShieldCheckIcon className="w-6 h-6 text-primary flex-shrink-0" />,
      text: "Enterprise-Grade Data Governance",
    },
    {
      icon: <CloudIcon className="w-6 h-6 text-primary flex-shrink-0" />,
      text: "Cloud-First Analytics",
    },
  ];
  ...
  return (
    <section className="container mx-auto px-4 mb-12">
      <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6">
        Transform Raw Data into Strategic <br />
        <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
          Business Assets
        </span>
      </h1>
      <p className="text-lg font-bold text-gray-600 mb-8">
        Advanced analytics solutions that drive smarter decisions and measurable growth.
      </p>
